    ...
    <footer className="section-gradient-soft border-t border-white/70">
      <div className="page-shell py-10 sm:py-12">
        <div className="glass-card-strong p-6 sm:p-8">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-[1.35fr_0.8fr_0.8fr_1fr]">
            <div>
          ...
          <div className="mt-8 border-t border-white/70 pt-5 text-xs font-medium text-slate-500">
